        ...
        <div class="modal-content">
            ...
            <form id="form-add-fee-rule" class="apics-modal-form" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn-save-fee-rule">Save rule</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable apics-modal">
        <div class="modal-content">
            ...
            <div class="modal-footer flex-wrap gap-2">
                <button type="button" class="btn btn-primary" id="btn-fee-edit">Edit</button>
                <button type="button" class="btn btn-danger" id="btn-fee-delete">Delete</button>
