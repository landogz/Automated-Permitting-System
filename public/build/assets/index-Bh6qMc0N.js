import{e as i,u as x,b as k,t as $}from"./app-B97eAumq.js";import{c as q}from"./create-apics-datatable-rUSVJS3p.js";const w={timeZone:"Asia/Manila"};function S(t){if(!t)return'<span class="text-muted">—</span>';const r=new Date(t);if(Number.isNaN(r.getTime()))return`<span class="text-muted">${i(t)}</span>`;const n=r.toLocaleDateString("en-US",{...w,month:"short",day:"numeric",year:"numeric"}),l=r.toLocaleTimeString("en-US",{...w,hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0});return`
