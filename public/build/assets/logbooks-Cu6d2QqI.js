import{e as i,t as g,b as $,f as v,s as w}from"./app-B97eAumq.js";import{c as E}from"./create-apics-datatable-rUSVJS3p.js";import{o as f}from"./index-DZam2Qhi.js";import{i as S}from"./application-select-B5Iz1eli.js";import"./site-map-viewer-ChF2lJr_.js";const L={g01_releasing:"G-01 Releasing",o02_occupancy:"O-02 Occupancy",e_series:"E-series",g05:"G-05",g06:"G-06"};function r(e){if(!e)return"—";try{return new Date(e).toLocaleString()}catch{return i(e)}}function x(e){return e.replaceAll("_"," ").replace(/\b\w/g,a=>a.toUpperCase())}function k(e){return`<span class="badge ${{g01_releasing:"bg-success-subtle text-success",o02_occupancy:"bg-primary-subtle text-primary",e_series:"bg-info-subtle text-info",g05:"bg-warning-subtle text-warning",g06:"bg-secondary-subtle text-secondary"}[e]||"bg-info-subtle text-info"}">${i(L[e]||x(e))}</span>`}function y(e){const a=(l,c)=>{document.querySelectorAll(`[data-lb-stat="${l}"]`).forEach(n=>{n.textContent=c})};if(!e){["g01_releasing","o02_occupancy","e_series","g05","g06","total"].forEach(l=>a(l,"—"));return}a("g01_releasing",String(e.g01_releasing??0)),a("o02_occupancy",String(e.o02_occupancy??0)),a("e_series",String(e.e_series??0)),a("g05",String(e.g05??0)),a("g06",String(e.g06??0)),a("total",String(e.total??0))}function I(e){const a=e.application||{};return`
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <p class="mb-0">${i(r(e.recorded_at))}</p>
            </div>
        </div>
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
                <div class="border rounded p-3 h-100 bg-light-subtle">
                    ...
                    <p class="mb-0"><span class="text-muted">At:</span> ${i(r(e.recorded_at))}</p>
                </div>
            </div>
        </div>
    ...
    `}function _(e){const a=e.print_url||`/admin/logbooks/${e.uuid}/print`;window.open(a,"_blank","noopener,noreferrer")}function O(){const e=document.getElementById("logbooks-table"),a=document.getElementById("form-add-logbook");if(!e||!a)return;const l=S(a);let c=null,n=null;const d=document.getElementById("logbook-detail-body"),p=document.getElementById("modal-logbook-detail-label"),u=document.getElementById("btn-lb-view-app"),m=document.getElementById("btn-lb-print"),h=t=>{n=t,p&&(p.textContent=`Logbook · ${t.entry_no}`),d&&(d.innerHTML=I(t)),u?.classList.toggle("d-none",!t.application?.uuid),m?.classList.remove("d-none"),w("modal-logbook-detail")};u?.addEventListener("click",()=>{const t=n?.application?.uuid;t&&(v("modal-logbook-detail"),f(t))}),m?.addEventListener("click",()=>{n&&_(n)}),(async()=>{try{c=await E({table:e,exportFileName:"logbook-entries",rowId:"uuid",searchMode:"server",order:[[0,"desc"]],filters:[{id:"book_type",label:"Book",options:[{value:"",label:"All"},{value:"g01_releasing",label:"G-01 Releasing"},{value:"o02_occupancy",label:"O-02 Occupancy"},{value:"e_series",label:"E-series"},{value:"g05",label:"G-05"},{value:"g06",label:"G-06"}]}],columns:[{data:"entry_no",title:"Entry No.",responsivePriority:1,render:t=>`<span class="fw-semibold">${i(String(t??""))}</span>`},{data:"book_type",title:"Book",responsivePriority:1,render:t=>k(String(t??""))},{data:"subject",title:"Subject",responsivePriority:1,render:(t,o,s)=>`<div class="fw-medium text-truncate" style="max-width:16rem">${i(String(t??""))}</div>
