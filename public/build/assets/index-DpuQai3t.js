import{e as i,b as P,t as $}from"./app-DpvXLM-T.js";import{c as q}from"./create-apics-datatable-DPPhyJg9.js";const w={timeZone:"Asia/Manila"};function S(t){if(!t)return'<span class="text-muted">—</span>';const n=new Date(t);if(Number.isNaN(n.getTime()))return`<span class="text-muted">${i(t)}</span>`;const d=n.toLocaleDateString("en-US",{...w,month:"short",day:"numeric",year:"numeric"}),l=n.toLocaleTimeString("en-US",{...w,hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0});return`
