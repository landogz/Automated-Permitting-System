import{e as i,b as k,t as $,d as be,i as _e,g as Se,s as q,f as oe,j as Le}from"./app-B0Qu8LZ8.js";import{c as je}from"./create-apics-datatable-CwDSWsUx.js";import{s as Y}from"./status-badge-CaU8VUam.js";import{d as Q,o as Be,n as ve,p as Ae,g as Te,a as Ie,s as ke,e as Me,t as Fe,b as Pe,f as De,c as de,h as Ce,i as ce,r as W,v as qe,j as He,k as Ue,l as Ne,m as re,q as Ve}from"./site-map-viewer-DcYWI6mI.js";function O(e){return e.replaceAll("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function ge(e){return!e||e<=0?"":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function Oe(e,t){const n=t.requiredLabels.length?t.requiredLabels:[],u=new Map(t.documents.map(s=>[s.label,s]));if(!t.applicationUuid){e.innerHTML=`
