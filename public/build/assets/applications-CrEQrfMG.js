import{e as i,b as k,t as $,d as be,i as _e,g as Se,s as q,f as oe,j as Le}from"./app-Da3N1zM7.js";import{c as je}from"./create-apics-datatable-B4drYWec.js";import{s as Y}from"./status-badge-CaU8VUam.js";import{d as Q,o as Be,n as ve,p as Ae,g as Te,a as Ie,s as ke,e as Me,t as Fe,b as Pe,f as De,c as de,h as Ce,i as ce,r as W,v as qe,j as He,k as Ue,l as Ne,m as re,q as Ve}from"./site-map-viewer-BPmwqozC.js";function O(e){return e.replaceAll("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function ge(e){return!e||e<=0?"":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function Oe(e,t){const n=t.requiredLabels.length?t.requiredLabels:[],u=new Map(t.documents.map(s=>[s.label,s]));if(!t.applicationUuid){e.innerHTML=`
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <p class="mb-0">${i(e.classification?M(e.classification):"—")}</p>
            </div>
            <div class="col-12">
        ...
        <div class="row g-3">
            <div class="col-md-5">
                <div class="border rounded p-3 h-100 bg-light-subtle">
                    ...
                    <p class="small mb-1">${Me(u||null)}</p>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                <div class="border rounded p-3 bg-light-subtle h-100">
                    ...
                    <p class="font-monospace fw-bold fs-5 mb-0">${u!=null&&u!==""?De(u):"—"}</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="border rounded p-3 bg-light-subtle h-100">
    ...
    `,m=ve(t).map(p=>{const g=p.fields.map(h=>{const x=n[h.name];return x==null||x===""?"":`<div class="col-sm-6 col-lg-4">
                        ...
                        <p class="mb-0 text-break">${Ce(h,x)}</p>
    ...
    <div class="mt-3 d-none" id="applicant-view-docs-fallback">${Re(t,e.uuid)}</div>`}function it(e){return e.length?e.map(t=>{const n=t.status==="issued",u=t.appeals||[],s=u.length>0?`<div class="mt-2 pt-2 border-top">
                        ...
                        ${u.map(d=>`<div class="small mb-2">
                                    <span class="badge bg-secondary-subtle text-secondary">${i(M(d.status))}</span>
                ...
                <div class="d-flex flex-wrap justify-content-between gap-2 mb-2">
                    <div>
                        ...
                        <span class="badge bg-info-subtle text-info ms-1">${i(M(t.status))}</span>
                    </div>
