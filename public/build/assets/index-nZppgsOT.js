import{e as i,t as b,d as L,b as $,j as Q,k as M,s as j}from"./app-DRefgvz5.js";import{n as B,h as A,I as m,f as T,c as x,y as O,z as _,A as F,e as N,t as U,b as z,d as K,J as W,p as J,g as G,a as V,s as X,m as C,l as Y,q as Z,o as P}from"./site-map-viewer-Cp5zlgLx.js";import{o as ee}from"./create-apics-datatable-CPLKmlT1.js";async function te(e){const t=e.payload||{},s=B(e.form?.schema||null).map(o=>{const c=o.fields.map(r=>{const n=t[r.name];if(n==null||n==="")return"";const l=A(r,n).replace(/<[^>]+>/g,"");return`<tr><th>${i(r.label)}</th><td>${i(l)}</td></tr>`}).filter(Boolean).join("");return c?`<h3 style="font-size:13px;margin:14px 0 6px;text-transform:uppercase;letter-spacing:.04em;color:#64748b">${i(o.title)}</h3>
